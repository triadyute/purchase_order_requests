            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="profile_photo" class="col-md-4 col-form-label text-md-right">{{ __('Upload file') }}</label>

                                <div class = "col-md-6 file-upload">
                                        <input type="file" class="file-upload" name="profile_photo" id="profile_photo">
                                </div>
                        </div>
